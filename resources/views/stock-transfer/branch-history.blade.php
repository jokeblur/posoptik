...
@section('title', 'Riwayat Transfer Stok - ' . $branch->name)
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Riwayat Transfer Stok - {{ $branch->name }}</h3>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Transfer Selesai</span>
                                <span class="info-box-number">{{ $transfers->where('status', 'Completed')->count() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center">Tidak ada data transfer stok untuk cabang ini</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
